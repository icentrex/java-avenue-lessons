...
public class Hippopotamus {
    ...
    public void showWhoIAm() {
        switch (this.getClass().getSimpleName()) {
            case "Cat":
                ...
                break;
            case "Hippopotamus":
                System.out.println("Я гиппопотам");
                break;
            default:
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(growth, that.growth) == 0 && Double.compare(weight, that.weight) == 0 && numberOfPaws == that.numberOfPaws && Objects.equals(name, that.name) && Objects.equals(color, that.color) && Objects.equals(favoriteFood, that.favoriteFood);
    }
